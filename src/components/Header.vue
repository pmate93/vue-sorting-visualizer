...
<div class="header">
  ...
  <div class="slidecontainer">
    ...
    <input @change="$emit('generate-array', range)" :disabled='this.disabled' type="range" name="range" v-model="range" min="4" max="100" class="slider">
  </div>
  <div>
    <button 
    v-for="button in buttons" 
    :key="button" :class="{active : sortType===button}" 
